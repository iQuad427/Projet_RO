...
if __name__ == '__main__':
    ...
    plt.plot(x_val[round(precision_of_pareto/2):], y_val[round(precision_of_pareto/2):], 'or')
    plt.plot(x_val[:round(precision_of_pareto/2)], y_val[:round(precision_of_pareto/2)], 'og')
    plt.show()
